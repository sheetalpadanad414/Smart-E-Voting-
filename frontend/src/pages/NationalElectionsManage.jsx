...
const NationalElectionsManage = () => {
  ...
  const NATIONAL_TYPES = ['Lok Sabha', 'Rajya Sabha'];
  ...
  const fetchElections = async () => {
    try {
      ...
      // Filter only national elections
      const nationalElections = response.data.elections.filter(
        e => NATIONAL_TYPES.includes(e.election_type)
      );
      setElections(nationalElections);
    } catch (error) {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">National Elections</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Manage Lok Sabha and Rajya Sabha elections</p>
          </div>
          <button
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white"
                    placeholder="e.g., Lok Sabha General Election 2024"
                    required
                  />
                </div>
              </div>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                {loading ? (
                  ...
                  <tr>
                    <td colSpan="6" className="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                      No national elections found. Create one to get started.
                    </td>
                  </tr>
                ) : (
...
export default NationalElectionsManage;
